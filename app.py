...
def opuser():
    ...
    data = cur.fetchall()
    return render_template('opuser.html', usuarios = data)
...
def opclien():
    ...
    data = cur.fetchall()
    return render_template('opclien.html', clientes = data)
...
def oprepor():
    ...
    data = cur.fetchall()
    return render_template('oprepor.html', reportes = data)
...
def opequipo():
    ...
    data = cur.fetchall()
    return render_template('opequipo.html', equipos = data)
...
def opservicio():
    ...
    data = cur.fetchall()
    return render_template('opservicio.html', servicios = data)
...
def opfoto():
    ...
    data = cur.fetchall()
    return render_template('opfoto.html', fotos = data)
...
def add_client():
    if request.method == 'POST':
        ...
        cur = mysql.connection.cursor()
        cur.execute('INSERT INTO clientes (CliNumDoc,CliDir,CliTel,IdEmpresa,CliNomRazSoc,CliTipoDoc) VALUES (%s,%s,%s,%s,%s,%s)',(CliNumDoc,CliDir,CliTel,IdEmpresa,CliNomRazSoc,CliTipoDoc))
        mysql.connection.commit()
...
def add_usuario():
    if request.method == 'POST':
        ...
        IdEmpresa =  request.form['IdEmpresa']
        cur = mysql.connection.cursor()
        cur.execute('INSERT INTO usuarios (UsuNom,UsuApe,UsuTipDoc,UsuNumDoc,UsuTipo,UsuEstado,UsuTel,UsuDir,UsuTipoContrat,UsuFechRegist,UsuHorRegist,UsuVenciContrat,UsuEstadoContrat,Usupass,IdEmpresa) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',(UsuNom,UsuApe,UsuTipDoc,UsuNumDoc,UsuTipo,UsuEstado,UsuTel,UsuDir,UsuTipoContrat,UsuFechRegist,UsuHorRegist,UsuVenciContrat,UsuEstadoContrat,Usupass,IdEmpresa))
        mysql.connection.commit()
